...
mafn=full/path/to/GCTA/maformat/GWAS/summary
targetpfn=full.path/to/plink/genotype/file
phefn=/full/path/to/target/pheno/file
outpath=full/path/to/outpath
outpref=outprefix

/home/rx235/PRSice_linux /home/rx235/PRSice.R  --base $mafn --snp SNP --a1 A1 --beta beta --target $targetpfn  --clump-kb 1000 --clump-r2 0.1 --score sum  --out $outpath/$outpref --extract /rds/project/asb38/rds-asb38-ceu-ukbiobank/projects/P7439/inouyelab/rx235/vqtl/prsice/prsout/chr22.tr01.valid --pheno $phefn --binary-target F


if [ $? -gt 0 ]; then
         echo "ERROR; PRSice.R failed"
         exit 1
       fi
